<?php
/**
* Simple PHP Markdown viewer 
* Courtesy of Neil Sweeney
* @url https://github.com/WolfieZero/Markdown-Viewer-PHP
*/
//if( isset($_GET['src']) ) {
	require('../inc_scripts/inc_scripts_class_markdown.php');
